...
//
// Change-Log
// 2026-01-30 - V1.1.1.0 - Change-Log eingefügt - Lukas schwarz
// 2026-01-30 - V1.1.1.1 - Changed Serverport to 10081 and Timeout to 10000100 - Sebastian Ceban
...
public class MyEchoServer extends Thread {
 ...
 public static void main(String[] args) throws IOException {
  ...
  String version = new String( "MyEchoServer - Version 1.1.1.0" );
  
  ServerSocket serverSocket = null;

  int serverPort = 10081;
        int myTimeout = 10000100;
        int quietFlag = 0;
